...
var init = function (props) {
    ...
    init_config.activeLanguage = options.defaultLanguage || languages[0].code;
    if (typeof options.onMissingTranslation === 'function') {
        init_config.onMissingTranslation = options.onMissingTranslation;
    }
};
...
/* harmony default export */ var src_useStore = (useStore);
...
var ProviderLocalization = function (_a) {
    ...
    var _b = src_useStore(init_config), state = _b[0], dispatch = _b[1];
...
/* harmony default export */ var src_Translate = (Translate);
